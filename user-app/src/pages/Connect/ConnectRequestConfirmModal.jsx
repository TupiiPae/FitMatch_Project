...
export default function ConnectRequestConfirmModal({
  ...
  switch (mode) {
    case "send_duo":
      ...
      primaryClass = "cn-modal-btn primary";
      break;
    case "send_group":
    ...
    case "cancel_duo":
      ...
      primaryClass = "cn-modal-btn cn-btn-reject";
      break;
    case "cancel_group":
    ...
    case "accept_duo":
      ...
      primaryClass = "cn-modal-btn success"; // nút xanh
      break;
    default:
  ...
  return (
    <div className="cn-modal-backdrop" data-fm-modal="true" onClick={handleClose}>

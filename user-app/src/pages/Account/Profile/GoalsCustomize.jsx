    ...
    <div className="card">
      ...
      <div className="goal-facts filled">
        <div className="fact-row">
          ...
          <strong>{Number.isFinite(p.bmr) ? Math.round(p.bmr) : "—"}</strong>
        </div>
        <div className="fact-row">
          <span>Tổng năng lượng tiêu thụ mỗi ngày (TDEE)</span>
          <strong>{Number.isFinite(p.tdee) ? Math.round(p.tdee) : "—"}</strong>
        </div>
      </div>
            ...
            <div className="acc-panel">
              <div className="pf-form-5">
                <div className="pf-form-cell">
                  ...
                  <input type="number" value={calDisplay} readOnly placeholder="vd. 2200" />
                </div>
                <div className="pf-form-cell">
                  <label>&nbsp;</label>
                  <button className="btn-success" disabled> Lưu calo </button>
                </div>
              </div>
            </div>
          )}
          ...
          {openKey === "macro" && (
            <div className="acc-panel">
              <div className="pf-form-5">
                ...
                <div className="pf-form-cell">
                  <label>&nbsp;</label>
                  <button className="btn-success" disabled> Lưu Macro </button>
                </div>
              </div>
            </div>
          )}

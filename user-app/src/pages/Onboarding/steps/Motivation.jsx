// user-app/src/pages/Onboarding/steps/Motivation.jsx
...
export default function Motivation() {
  ...
  const handleNext = () => {
    if (goal === "duy_tri") {
      ...
      // ❗ BasicMetrics đã gôm vào Nickname, nên non-duy_tri đi thẳng tới TargetWeight
    ...
    <div className="mv-wrap">
      ...
      <main className="mv-main">
        ...
        <div className="mv-card">
          ...
          {goal && (
            <p className="mv-sub">
              Mục tiêu bạn chọn: <strong>{GOAL_LABEL[goal] || ""}</strong>
            </p>
          )}
          ...
          <div className="mv-section">
            <div className="mv-box">
              <p>
                Hãy cố gắng cho cuộc hành trình sắp tới nhé! Chúng tôi sẽ đồng hành và
                hỗ trợ bạn hết mình để đạt được mục tiêu.
              </p>
              <p>
                Sẽ có lúc khó khăn và mệt mỏi, nhưng đừng nản chí. Mỗi bước nhỏ hôm
                nay sẽ tạo nên thay đổi lớn ngày mai. 💪
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mv-actions">
          <button
            ...
            onClick={() => nav("/onboarding/muc-tieu")}
          >
            Quay lại
          </button>
